												...
												<div class="widget-main">
													...
													<?php
														...
														<li>
															...
															<button name="check1" type="submit">click me</button>
														</li>
														<?php
																} 
															}
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<?php
														...
														<li>
															<i class="ace-icon fa fa-check "></i>
															<button name="check2" type="submit">click me</button>
														</li>
														<?php
																} 
															}
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<?php
														...
														<li>
															<i class="ace-icon fa fa-check "></i>
															<button name="check3" type="submit">click me</button>
														</li>
														<?php
																} 
															}
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<?php
														...
														<li>
															<i class="ace-icon fa fa-check "></i>
															<button name="check4" type="submit">click me</button>
														</li>
														<?php
																} 
															}
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<?php
														...
														<li>
															<i class="ace-icon fa fa-check "></i>
															<button name="check5" type="submit">click me</button>
														</li>
														<?php
																} 
															}
