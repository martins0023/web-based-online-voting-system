						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
												...
												<div class="widget-main">
													...
													<?php
														...
														<li>
															...
															<button name="vcheck1" type="submit">click me</button>
														</li>
														<?php
																} 
															}
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<?php
														...
														<li>
															<i class="ace-icon fa fa-check "></i>
															<button name="vcheck2" type="submit">click me</button>
														</li>
														<?php
																} 
															}
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<?php
														...
														<li>
															<i class="ace-icon fa fa-check "></i>
															<button name="vcheck3" type="submit">click me</button>
														</li>
														<?php
																} 
															}
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<?php
														...
														<li>
															<i class="ace-icon fa fa-check "></i>
															<button name="vcheck4" type="submit">click me</button>
														</li>
														<?php
																} 
															}
									...
									<center>
									<?php
									$sql = 'select * from vice1 where id=5'; // change this id as per your need
									$result = mysqli_query($connection, $sql) or die('Error ' . mysqli_error($connection));
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<?php
														...
														<li>
															<i class="ace-icon fa fa-check "></i>
															<button name="vcheck5" type="submit">click me</button>
														</li>
														<?php
																} 
															}
